...
public class ModelAPI {
	...
	public boolean posicionarTropas(Jogador j, Territorio pais, int qtd) {
		if (pais.corDominando != j.cor) {
	...
	public boolean moverTropas(Jogador j, Territorio paisOrigem, Territorio paisDestino, int qtd) {
		if (paisOrigem.corDominando != j.cor) {
			System.out.println("O paisOrigem não pertence ao Jogador");
			return false;
		}
		
		if (paisDestino.corDominando != j.cor) {
	...
	public boolean atacarTerritorio(Jogador j, Territorio aliado, Territorio inimigo) {
		if (aliado.corDominando != j.cor)
			return false;
		
		if (inimigo.corDominando == j.cor)
			return false;
